...
module Firebase {
  ...
  module Database {
    ...
    DataFlow::SourceNode query(DataFlow::TrackSummary t) {
      t.start() and
      (
     ...
     */
    DataFlow::SourceNode transactionCallback(DataFlow::TrackSummary t) {
      t.start() and
  ...
  module CloudFunctions {
    ...
    DataFlow::SourceNode namespace(DataFlow::TrackSummary t) {
      t.start() and
    ...
    DataFlow::SourceNode database(DataFlow::TrackSummary t) {
      t.start() and
    ...
    DataFlow::SourceNode refBuilder(DataFlow::TrackSummary t) {
      t.start() and
